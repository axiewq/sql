...
SELECT ship_city, ship_country FROM orders WHERE ship_city like ('%burg')
...
SELECT country, COUNT(*) AS quantity FROM suppliers GROUP BY country ORDER BY quantity DESC
